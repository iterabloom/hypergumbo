...
# Cursor session-end hook adapter
...
# Cursor uses the constant cursor-singleton because it is enforced
# single-session-per-repo. See cursor/session-start.sh for the rationale.
