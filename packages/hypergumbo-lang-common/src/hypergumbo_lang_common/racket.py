            ...
            if _is_function_define(node):
                ...
                if name:
                    ...
                    sym = Symbol(
                        ...
                        stable_id=self._ts_analyzer.compute_stable_id(
                            node, kind="function", name=name,
                            file_stable_id=self._ts_analyzer._file_anchor(rel_path),
                        ),
                        name=name,
                        kind="function",
                        language="racket",
...
@register_analyzer("racket", language_state="no_taxonomy_spec")  # WI-futin
