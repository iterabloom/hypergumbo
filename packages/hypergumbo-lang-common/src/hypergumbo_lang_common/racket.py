        ...
        if _is_define_form(node):
            if _is_function_define(node):
                ...
                if name:
                    ...
                    sym = Symbol(
                        ...
                        stable_id=self._ts_analyzer.compute_stable_id(node, kind="function", name=name),
                        name=name,
                        kind="function",
                        language="racket",
                        path=rel_path,
                ...
                if name:
                    ...
                    sym = Symbol(
                        ...
                        stable_id=self._ts_analyzer.compute_stable_id(node, kind="variable", name=name),
                        name=name,
                        kind="variable",
                        language="racket",
                        path=rel_path,
            ...
            if name:
                ...
                sym = Symbol(
                    ...
                    stable_id=self._ts_analyzer.compute_stable_id(node, kind="class", name=name),
                    name=name,
                    kind="class",
                    language="racket",
                    path=rel_path,
