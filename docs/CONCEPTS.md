...
| `application` | inert | aiohttp, giraffe, http4s, hummingbird, javalin, openresty, padrino, plumber, qt, roda, scotty, servant, shiny, swiftui, tornado, yesod, zio | _(none)_ |
...
| `benchmark_function` | inert | test-frameworks | _(none)_ |
| `bookmark` | inert | shiny | _(none)_ |
| `bootstrap` | inert | yii | _(none)_ |
| `broadcast` | inert | masonite | _(none)_ |
| `broker_lifecycle_by_name` | inert | naming-conventions | _(none)_ |
...
| `cargo_binary` | inert | config-conventions | _(none)_ |
...
| `command` | live | adonisjs, cakephp, cli, cli-go, cli-js, cli-ruby, cli-rust, codeigniter, django, flask, fuelphp, laminas, laravel, lumen, masonite, symfony, vapor, yii | `linkers/subprocess_cli.py` |
| `command_by_name` | inert | naming-conventions | _(none)_ |
...
| `entity` | inert | cakephp, codeigniter | _(none)_ |
| `entrypoint` | inert | akka-http, cli, cli-go, cli-ruby, electron | _(none)_ |
| `error` | inert | cli | _(none)_ |
| `error_handler` | inert | adonisjs, akka-http, bottle, fastapi, fastify, feathers, flask, flask-restful, giraffe, grape, hapi, javalin, jax-rs, ktor, laravel, litestar, lumen, micronaut, nuxt, openresty, padrino, plug, pyramid, quart, remix, restify, ring-compojure, sanic, scalatra, scotty, servant, sinatra, slim, spring-boot, sveltekit, tornado, vertx | _(none)_ |
| `event` | inert | adonisjs, fuelphp, laravel, masonite | _(none)_ |
| `event_config` | inert | lit | _(none)_ |
| `event_consumer` | inert | vertx | _(none)_ |
| `event_handler` | inert | celery, django, guice, hapi, jakarta-cdi, laravel, micronaut, nestjs, openresty, pyramid, qt, quarkus, rails, sanic, spring-boot, symfony, yii | _(none)_ |
...
| `example_function` | inert | test-frameworks | _(none)_ |
...
| `graphql_resolver` | inert | graphql, graphql-python, graphql-ruby, phoenix | _(none)_ |
| `graphql_schema` | inert | graphql, graphql-python, graphql-ruby, phoenix | _(none)_ |
...
| `handler_by_name` | inert | naming-conventions | _(none)_ |
...
| `ipc_handler` | inert | electron, tauri | _(none)_ |
...
| `library_export` | inert | library-exports | _(none)_ |
| `lifecycle` | inert | aiohttp, electron, fastapi, hapi, restify, ring-compojure, solid | _(none)_ |
| `lifecycle_hook` | inert | android, cocoa, lit, nex, quart, sanic | _(none)_ |
| `listener` | inert | adonisjs | _(none)_ |
| `liveview` | inert | phoenix | _(none)_ |
...
| `main_function` | inert | main-functions | _(none)_ |
...
| `npm_bin` | inert | config-conventions | _(none)_ |
...
| `pyproject_script` | inert | config-conventions | _(none)_ |
...
| `scheduled_task` | inert | celery, go-web, rails | _(none)_ |
| `schema` | inert | cli-rust, fastify | _(none)_ |
...
| `serialization_callback` | inert | go-encoding-callbacks | _(none)_ |
...
| `task` | inert | celery, django, go-web, laravel, phoenix, quarkus, rails, rust-web, spring-boot, symfony | _(none)_ |
...
| `test_function` | inert | test-frameworks | _(none)_ |
...
| `websocket_gateway` | inert | nestjs | _(none)_ |
| `websocket_handler` | inert | aiohttp, akka-http, cowboy, express, falcon, fastify, feathers, flask, graphql, ktor, laravel, litestar, micronaut, nestjs, phoenix, play, quart, rails, sanic, tornado, vapor | _(none)_ |
