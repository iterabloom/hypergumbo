...
- **36547** symbols (functions, classes, methods)
- **124323** edges by type:
  - calls: 64602
  - contains: 33723
  - imports: 11089
  - instantiates: 8353
...
│  Output: 36547 Symbols + 124323 Edges + UsageContexts           │
└─────────────────────────────────────────────────────────────────┘
     │
     ▼
┌─────────────────────────────────────────────────────────────────┐
...
| `write_text` | external_symbol | 3262.0 | <external> |
...
| `get` | external_symbol | 1076.0 | <external> |
