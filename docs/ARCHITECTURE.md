...
- **35842** symbols (functions, classes, methods)
- **121831** edges by type:
  - calls: 63004
  - contains: 32994
  - imports: 10992
  - instantiates: 8419
...
│  Output: 35842 Symbols + 121831 Edges + UsageContexts           │
└─────────────────────────────────────────────────────────────────┘
     │
     ▼
┌─────────────────────────────────────────────────────────────────┐
...
|--------|------|-------|----------|
| `Symbol` | class | 9222.0 | ir.py |
| `Span` | class | 6207.0 | ir.py |
| `run_behavior_map` | function | 3390.7 | cli.py |
| `write_text` | external_symbol | 3259.0 | <external> |
| `LinkerContext` | class | 2916.9 | registry.py |
