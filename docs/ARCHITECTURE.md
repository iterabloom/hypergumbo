...
- **37948** symbols (functions, classes, methods)
- **129083** edges by type:
  - calls: 65109
  - contains: 35048
  - imports: 11499
  - instantiates: 10537
...
│  Output: 37948 Symbols + 129083 Edges + UsageContexts           │
└─────────────────────────────────────────────────────────────────┘
     │
     ▼
┌─────────────────────────────────────────────────────────────────┐
...
|--------|------|-------|----------|
| `Symbol` | class | 9437.5 | ir.py |
| `Span` | class | 6351.4 | ir.py |
...
| `Path` | external_symbol | 1635.0 | <external> |
