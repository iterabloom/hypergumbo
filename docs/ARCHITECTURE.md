...
- **35786** symbols (functions, classes, methods)
- **121466** edges by type:
  - calls: 62719
  - contains: 32940
  - imports: 10983
  - instantiates: 8404
...
│  Output: 35786 Symbols + 121466 Edges + UsageContexts           │
└─────────────────────────────────────────────────────────────────┘
     │
     ▼
┌─────────────────────────────────────────────────────────────────┐
...
| `Path` | external_symbol | 1514.0 | <external> |
