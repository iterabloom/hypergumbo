...
```json
{
  ...
  "stable_id_scheme": "hypergumbo-stableid-v6",
...
v6 is the **current shipped value**. This per-transition history is maintained as the precondition for each bump (never bump a scheme onto an undocumented chain).
