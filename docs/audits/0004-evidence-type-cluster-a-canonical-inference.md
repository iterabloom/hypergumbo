...
# Audit-findings 0004: Edge.evidence_type Cluster A — Canonical Inference Pathways

- Date: 2026-05-05
- Status: All rows RESOLVED
- Closes: WI-nurot-lituj-ganoh-nujup-gigot-dohib-mosas-vikub (Cluster A audit-findings: canonical inference-pathway evidence types, ADR-0028 Phase 3)
...
The CANONICAL / FOLD / DEPRECATE-NO-FOLD trichotomy and the four-leakage-test diagnostic procedure are defined in [ADR-0024 §"Family-audit verdict methodology"](../adr/0024-axis-declaration-template.md). This document applies that methodology to the Cluster A subset of `Edge.evidence_type` values.
...
verdicts:
  - value: ast_annotation
    ...
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from a type/decorator annotation in source AST."
  - value: ast_attribute
    verdict: CANONICAL
    fold_target: null
    status: RESOLVED
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from an attribute access in source AST."
  - value: ast_call
    verdict: CANONICAL
    fold_target: null
    status: RESOLVED
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from a generic call expression in source AST."
  - value: ast_call_direct
    ...
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from a direct (non-method) call site."
  - value: ast_call_extension
    ...
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from an extension-method call (Kotlin / Swift / C#)."
  - value: ast_call_inherited
    ...
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from a call on an inherited member."
  - value: ast_call_inherited_field
    ...
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from access to an inherited field."
  - value: ast_call_inherited_method
    ...
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from a call on an inherited method."
  - value: ast_call_static
    ...
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from a static (class-level) method call."
  - value: ast_call_this
    verdict: CANONICAL
    fold_target: null
    status: RESOLVED
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from a `this`/`self` receiver call."
  - value: ast_call_this_property
    ...
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from a `this.property` / `self.attr` resolved access."
  - value: ast_call_type_inferred
    ...
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from a call site where the receiver type was inferred."
  - value: ast_cite
    verdict: CANONICAL
    fold_target: null
    status: RESOLVED
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from a citation/cross-reference link in source."
  - value: ast_decorator
    verdict: CANONICAL
    fold_target: null
    status: RESOLVED
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from a decorator/annotation node in source AST."
  - value: ast_extends
    verdict: CANONICAL
    fold_target: null
    status: RESOLVED
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from an `extends` clause in source AST."
  - value: ast_implements
    ...
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from an `implements` clause in source AST."
  - value: ast_import
    verdict: CANONICAL
    fold_target: null
    status: RESOLVED
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from an import statement in source AST."
  - value: ast_include
    verdict: CANONICAL
    fold_target: null
    status: RESOLVED
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from an include directive in source AST (C/C++)."
  - value: ast_method_inferred
    ...
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from a method call where dispatch was inferred."
  - value: ast_method_this
    ...
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from a `this`/`self` method call."
  - value: ast_method_this_property
    ...
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from a `this.prop` / `self.attr` reference."
  - value: ast_method_type_inferred
    ...
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from a method call with type-inferred receiver."
  - value: ast_new
    verdict: CANONICAL
    fold_target: null
    status: RESOLVED
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from a `new` constructor expression."
  - value: ast_package
    verdict: CANONICAL
    fold_target: null
    status: RESOLVED
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from a package declaration."
  - value: ast_perform
    verdict: CANONICAL
    fold_target: null
    status: RESOLVED
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from a `perform`/effect-handler invocation (OCaml/Eff)."
  - value: ast_ref
    verdict: CANONICAL
    fold_target: null
    status: RESOLVED
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from a generic name reference in source AST."
  - value: ast_static_call
    ...
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from a static method call (qualifier-resolved)."
  - value: ast_type_ref
    verdict: CANONICAL
    fold_target: null
    status: RESOLVED
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from a type reference (annotation, generic, etc.)."
  - value: async_spawn
    verdict: CANONICAL
    fold_target: null
    status: RESOLVED
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from an async spawn / task-creation construct."
  - value: behaviour
    verdict: CANONICAL
    fold_target: null
    status: RESOLVED
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from an Erlang `-behaviour(...)` attribute."
  - value: behaviour_callback
    ...
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from an Erlang behaviour callback definition."
  - value: bridging_header_import
    ...
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from an Objective-C bridging-header import."
  - value: build_dependency
    ...
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from a build-system dependency declaration."
  - value: build_target_main
    ...
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from a build target's main entry point."
  - value: callable_reference
    ...
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from a callable reference (Kotlin `::fn`, etc.)."
  - value: callback_argument_reference
    ...
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from a callback function passed as an argument."
  - value: canonical_name
    ...
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from canonical-name resolution."
  - value: cgo_call
    verdict: CANONICAL
    fold_target: null
    status: RESOLVED
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from a Go cgo C-function call."
  - value: closure_wrapper
    ...
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from a closure/lambda wrapper construct."
  - value: cmake_target_link
    ...
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from a CMake `target_link_libraries` call."
  - value: constructor_reference
    ...
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from a constructor reference (Java `::new`, etc.)."
  - value: designated_init_fptr
    ...
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from a designated-initializer function pointer (C99)."
  - value: dispatch_pattern
    ...
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from a generic dispatch-pattern recognition."
  - value: dispatch_table_initializer
    ...
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from a dispatch-table initializer entry."
  - value: dispatch_table_reference
    ...
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from a reference into a dispatch table."
  - value: dockerfile_copy_from
    ...
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from a Dockerfile `COPY --from=...` directive."
  - value: dockerfile_from
    ...
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from a Dockerfile `FROM` directive."
  - value: enclosing_scope
    ...
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from an enclosing-scope relationship."
  - value: eta_expansion
    verdict: CANONICAL
    fold_target: null
    status: RESOLVED
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from an eta-expansion (point-free → pointed)."
  - value: extends
    verdict: CANONICAL
    fold_target: null
    status: RESOLVED
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from a generic extends/inheritance relationship."
  - value: function_pointer
    ...
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from a function-pointer assignment or use."
  - value: function_pointer_arg
    ...
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from a function pointer passed as an argument."
  - value: function_reference
    ...
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from a function reference (not a call)."
  - value: function_reference_arg
    ...
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from a function reference passed as an argument."
  - value: hash_field_reference
    ...
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from a hash/dict field reference."
  - value: hg_annotation
    verdict: CANONICAL
    fold_target: null
    status: RESOLVED
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from a hypergumbo-emitted analyzer annotation."
  - value: import
    verdict: CANONICAL
    fold_target: null
    status: RESOLVED
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from a generic import construct."
  - value: import_declaration
    ...
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from an import declaration node."
  - value: import_directive
    ...
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from an import directive (C# `using`, etc.)."
  - value: import_statement
    ...
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from an import statement node."
  - value: import_static
    verdict: CANONICAL
    fold_target: null
    status: RESOLVED
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from a Java `import static` declaration."
  - value: import_to_manifest
    ...
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from a manifest-driven import resolution."
  - value: include
    verdict: CANONICAL
    fold_target: null
    status: RESOLVED
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from a generic include construct."
  - value: include_directive
    ...
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from a `#include` directive (C / C++)."
  - value: instance
    verdict: CANONICAL
    fold_target: null
    status: RESOLVED
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from a typeclass / trait instance declaration."
  - value: interface_dispatch
    ...
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from interface-method dispatch resolution."
  - value: jsx_element
    verdict: CANONICAL
    fold_target: null
    status: RESOLVED
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from a JSX element reference."
  - value: link
    verdict: CANONICAL
    fold_target: null
    status: RESOLVED
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from an OTP link/monitor relationship."
  - value: make_prerequisite
    ...
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from a Make/CMake prerequisite declaration."
  - value: message_send
    verdict: CANONICAL
    fold_target: null
    status: RESOLVED
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from a message-send construct (Erlang `!`, Smalltalk)."
  - value: method_reference
    ...
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from a method reference (Java `::method`, etc.)."
  - value: module_attribute_reference
    ...
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from a module-level attribute reference."
  - value: module_export_heuristic
    ...
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from a module-export heuristic recognition."
  - value: module_identifier_reference
    ...
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from a module-qualified identifier reference."
  - value: module_source
    verdict: CANONICAL
    fold_target: null
    status: RESOLVED
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from a module's source-file relationship."
  - value: naming_convention
    ...
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from a language-level naming convention."
  - value: notify
    verdict: CANONICAL
    fold_target: null
    status: RESOLVED
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from a notification/signal construct."
  - value: object_field_reference
    ...
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from an object-field reference."
  - value: open
    verdict: CANONICAL
    fold_target: null
    status: RESOLVED
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from an `open` directive (OCaml / F#)."
  - value: open_import
    verdict: CANONICAL
    fold_target: null
    status: RESOLVED
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from a Go open-import (qualified-but-unbound)."
  - value: recipe_dependency
    ...
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from a Bazel/Buck recipe-dependency declaration."
  - value: reference
    verdict: CANONICAL
    fold_target: null
    status: RESOLVED
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from a generic name-reference."
  - value: require
    verdict: CANONICAL
    fold_target: null
    status: RESOLVED
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from a `require` construct (Ruby / Node)."
  - value: require_alias_call
    ...
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from a `require(...)` aliased to a local name."
  - value: require_dynamic
    ...
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from a dynamic `require(...)` call."
  - value: require_statement
    ...
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from a top-level `require` statement."
  - value: require_static
    ...
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from a static `require(...)` invocation."
  - value: schema_relation
    ...
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from a schema-declared relation."
  - value: scip_occurrence_ref
    ...
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from a SCIP occurrence cross-reference."
  - value: scip_relationship
    ...
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from a SCIP-emitted symbol-relationship record."
  - value: signal_constraint
    ...
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from an HDL signal-constraint declaration."
  - value: source_statement
    ...
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from a generic source-level statement."
  - value: span_overlap
    verdict: CANONICAL
    fold_target: null
    status: RESOLVED
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from text-span overlap between symbols."
  - value: sql_foreign_key
    ...
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from a SQL `FOREIGN KEY` constraint."
  - value: stack_construction
    ...
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from a stack-frame construction site."
  - value: static
    verdict: CANONICAL
    fold_target: null
    status: RESOLVED
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from a static-linkage declaration."
  - value: struct_field_reference
    ...
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from a struct-field reference."
  - value: subdir_include
    ...
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from a subdirectory-include in a build file."
  - value: trait_impl
    verdict: CANONICAL
    fold_target: null
    status: RESOLVED
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from a Rust `impl Trait for Type` block."
  - value: tree_sitter
    verdict: CANONICAL
    fold_target: null
    status: RESOLVED
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from a tree-sitter query match."
  - value: type_hierarchy
    ...
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from a type-hierarchy traversal."
  - value: typeclass_instance
    ...
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from a typeclass-instance declaration (Haskell, Scala)."
  - value: use
    verdict: CANONICAL
    fold_target: null
    status: RESOLVED
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from a `use` directive (Rust, PHP)."
  - value: use_declaration
    ...
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from a `use` declaration node."
  - value: use_directive
    verdict: CANONICAL
    fold_target: null
    status: RESOLVED
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from a `use` directive (qualifier-bound)."
  - value: use-package
    verdict: CANONICAL
    fold_target: null
    status: RESOLVED
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from a Common Lisp `use-package` form (hyphenated identifier per CL convention)."
  - value: using_directive
    ...
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from a `using` directive (C# / C++)."
  - value: variable_match
    ...
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from a variable-name match across sites."
  - value: verilog_instantiation
    ...
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from a Verilog module instantiation."
  - value: vhdl_architecture
    ...
    diagnostic_test:
      ...
      expect: exit_code:0
    rationale: "Cluster A inference pathway: Edge inferred from a VHDL architecture declaration."
```

## Related

- [ADR-0028: Edge.evidence_type Names the Inference Pathway, Not Resolution Status](../adr/0028-evidence-type-inference-pathway-not-resolution-status.md) — the originating axis declaration. Cluster A is the canonical seed.
- [ADR-0027: Symbol.kind Names the Source-Language Syntactic Construct](../adr/0027-symbol-kind-language-construct-only.md) — sibling-axis ADR; Cluster A audit-findings 0003 carries the analogous canonical seed for `Symbol.kind`.
...
- [Audit-findings 0003](0003-symbol-kind-cluster-a-language-constructs.md) — sibling Cluster A audit on the `Symbol.kind` axis.
