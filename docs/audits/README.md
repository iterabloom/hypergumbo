...
| [0005](0005-symbol-kind-cluster-b-file-shape.md) | Symbol.kind Cluster 27B — File-Shape and Package-Shape Entities | `Symbol.kind` | All RESOLVED |
| [0006](0006-symbol-kind-cluster-g-build-config-shape.md) | Symbol.kind Cluster 27G — Build / Config-Shape Entities | `Symbol.kind` | All RESOLVED |
| [0007](0007-symbol-kind-cluster-h-long-tail.md) | Symbol.kind Cluster 27H — Domain-Specific Long Tail | `Symbol.kind` | All RESOLVED |
| [0008](0008-evidence-type-cluster-b-resolution-status.md) | Edge.evidence_type Cluster 28B — Resolution-Status Leakage | `Edge.evidence_type` | All RESOLVED |
| [0009](0009-symbol-kind-cluster-c-apex-peer.md) | Symbol.kind Cluster 27C — Apex/Peer Overloads | `Symbol.kind` | All RESOLVED |
| [0010](0010-symbol-kind-cluster-e-edge-label-kinds.md) | Symbol.kind Cluster 27E — Edge Labels Masquerading as Kinds | `Symbol.kind` | All RESOLVED |
| [0011](0011-symbol-kind-cluster-f-component-refs.md) | Symbol.kind Cluster 27F — Component References | `Symbol.kind` | All RESOLVED |
| [0012](0012-evidence-type-cluster-d-call-construct.md) | Edge.evidence_type Cluster 28D — Apex/Peer Call-Construct Overloads | `Edge.evidence_type` | All RESOLVED |
| [0013](0013-symbol-kind-cluster-d-framework-roles.md) | Symbol.kind Cluster 27D — Framework Roles | `Symbol.kind` | All RESOLVED |
...
| [0017](0017-endpoint-shape-long-tail.md) | Endpoint-Shape Long-Tail Classifications | `Edge.edge_type` | Mixed (1 RESOLVED, 19 PRELIM_RESOLVED, 2 UNRESOLVED) |
