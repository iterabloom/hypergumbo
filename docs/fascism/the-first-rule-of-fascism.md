...
The claim is **not** that a coverage threshold is a death camp. The claim is that there is a *structural signature* — recuperation of dissent, aestheticization of metric, coding of exception as betrayal, decoupling of the model from the world it claims to track — and the signature recurs at multiple scales because institutions keep rediscovering the same administrative pattern. At state scale, the pattern can kill journalists. At org scale, it turns engineering memory into holy scripture: the version pin remains, the reason dies, and dissent becomes the act of asking why. Not the same crime. Not the same moral universe. A homologous administrative shape. The shape is what the word names.

The objection that *fascism* properly names only its interwar European state-form runs against a lineage of theorists who located fascism below the state. Reich (*The Mass Psychology of Fascism*, 1933) found it in mass character-structure, produced by the authoritarian family before any party requires it. Theweleit (*Male Fantasies*, 1977/78) found it in the Freikorps, who had built fascism's emotional operating system before they possessed its state machinery. Foucault, prefacing *Anti-Oedipus*, named the fascism "in our heads and in our everyday behavior" — the kind that makes us desire the thing that dominates us. Deleuze and Guattari (*A Thousand Plateaus*, plateau 9) gave the two scales their names: molar fascism is the state, the regime, the camp; molecular fascism is the office, the form, the desire.

So: lowercase fascism. Nobody was dismembered over a coverage threshold; the scale is small, and the pattern underneath, unfortunately, is not. If you reject the lineage, reject this essay there — on theoretical grounds — not by claiming it mistakes busywork for murder.
...
Saudi Arabia ran a trial. Low-level operatives were convicted. Five were sentenced to death; those sentences were later commuted to prison terms after Khashoggi's children issued a pardon. The men who ordered the killing were never charged. An accountability *process* was run, in public, and produced no accountability. State visits resumed. The editorial columns remained in the newspaper archive. A permitted outlet that changed nothing.

There is no Mohammed bin Salman School of Journalism, although King Abdullah University of Science and Technology is a real institution, and its host regime really did murder Jamal Khashoggi. Perhaps King Abdullah University of Science and Technology *should* have a School of Journalism. Although perhaps it should not be named after Mohammed bin Salman.
