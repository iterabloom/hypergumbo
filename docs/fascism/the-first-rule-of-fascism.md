...
So: lowercase fascism. Nobody has been killed over a coverage threshold; the scale is small, and the pattern underneath, unfortunately, is not. If you reject the lineage, reject this essay there — on theoretical grounds — not by claiming it mistakes busywork for murder.
